...
router.get("/profiles/:username", userController.ifUserExists, userController.sharedProfileData, userController.profilePostsScreen)
router.get("/profiles/:username/followers", userController.ifUserExists, userController.sharedProfileData, userController.profileFollowersScreen)
// router.get("/profiles/:username/following", userController.ifUserExists, userController.sharedProfileData, userController.profileFollowingsScreen)
...
router.post("/removeFollow/:username", mustBeLoggedIn, followController.removeFollow)
